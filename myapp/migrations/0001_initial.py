# Generated by Django 5.0.4 on 2024-07-09 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('supervisor', 'Supervisor'), ('production', 'Production Staff'), ('warehouse', 'Warehouse Staff')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.user')),
            ],
        ),
    ]
